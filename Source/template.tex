...
%	 ABOUT ME
%----------------------------------------------------------------------------------------
\aboutme {$\bullet$ 1.5+ years work experiance as molecular biologist.\\
...
\skills{{Databases (NCBI, BLAST, FASTA)/3.0},{ABI Genetic Gequencer(3130XL)/5.8},{Primer Designing and Walking/4},{Microbial Identification /4.3},{PCR(AFLP, RAPD, Allele Specific)/5.8},{Sanger Sequencing/5.8}}
