...
\cvjobtitle{Research Associated\\} % Job title/career
...
%	 ABOUT ME
%----------------------------------------------------------------------------------------
\aboutme {$\bullet$Total 3.5 years work experience \\
...
\skills{{DNA, RNA, Plasmid Isolation/6.0},{Tissue Culture/4.0},{RAPD, SNP, Allele Specific, AFLP /4.3},{PCR/5.8},{Sanger Sequencing/5.8}, {NGS Library Preparation/5.8}}
...
\begin{twenty} % Environment for a list with descriptions
	...
	$\bullet$Performing NGS based wet lab process for PGT and NIPT from islolation to \phantom{ix}setting up of the sequence run \\
	$\bullet$ Handling of NextSeq and MiSeq\\
	$\bullet$ Handling of Hamilton for NIPT samples processing\\
	$\bullet$ Processing of PGT-M samples through NGS and Sanger based technique
	}
